namespace WindowsApplication1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblInfo.Text = "Нажмите мышкой на эту метку  и, удерживая ее, перетащите мышку в любое место экра" +
                "на. Отпустите мышку и цвет, который в данный момент находится под указателем мыш" +
                "ки, отобразится в метке.";
            // 
            // Form1
            // 
